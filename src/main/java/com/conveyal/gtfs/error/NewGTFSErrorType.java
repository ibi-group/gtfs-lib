...
public enum NewGTFSErrorType {
    ...
    FLEX_FORBIDDEN_CONTINUOUS_DROP_OFF(Priority.HIGH, "continuous_drop_off other than 1 or empty is not allowed when either start_pickup_drop_off_window or end_pickup_drop_off_window is defined."),
    FLEX_FORBIDDEN_CONTINUOUS_PICKUP(Priority.HIGH, "continuous_pickup other than 1 or empty is not allowed when either start_pickup_drop_off_window or end_pickup_drop_off_window is defined."),
    ...
    FLEX_FORBIDDEN_DUPLICATE_LOCATION_GROUP_ID(Priority.HIGH, "location_group_id that matches a stop_id or location_id is not allowed."),
    FLEX_FORBIDDEN_LOCATION_GROUP_ID(Priority.HIGH, "location_group_id is not allowed if a stop_id or location_id is defined."),
    FLEX_FORBIDDEN_DUPLICATE_LOCATION_ID(Priority.HIGH, "location_id that matches a stop_id or location_group_id is not allowed."),
    ...
    LOCATION_GROUP_STOPS_PARSING(Priority.HIGH, "Unable to parse the location_group_stops.txt file. Make sure the file conforms to the GTFS Flex standard."),
